...
def simple_out_to_simple_in(last_run_dir, next_run_dir, run_id, future):
    """
        ...
        Raises:
    """
    params_out = simple_parser.read_output_file(last_run_dir) 
    simple_parser.write_input_file(params_out, run_dir=next_run_dir)
    
    return last_run_dir, next_run_dir, run_id