...
def run_simulation_task(runner_args:dict, run_dir:str, out_dir:str, params_from_sampler: dict=None, future=None) -> dict:
        """
        ...
        runner = getattr(importlib.import_module(f'runners.{runner_type}'),runner_type)(**args.runner)
        try:
            if out_dir == None:
                out_dir = run_dir
