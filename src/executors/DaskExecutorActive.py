...
class DaskExecutorActive():
    ...
    def __init__(self, sampler=None, total_budget=np.inf, max_cycles=np.inf, time_limit=np.inf, **kwargs):
        ...
        if not os.path.isdir(self.base_run_dir):
            ...
            if os.path.isfile(os.path.join(self.base_run_dir,'ENCHANTED.FINNISHED')):
                raise FileExistsError(f'''
                                      The ENCHANTED.FINNISHED file is in, {self.base_run_dir}, 
    ...
    def initialize_client(self):
        self.static_executor.initialize_client(slurm_out_dir=os.path.join(self.base_run_dir, 'dask_worker_stdout'))
    ...
    def start_runs(self):
        ...
        initial_dir = os.path.join(self.base_run_dir, 'active_cycle_0')
        ...
        finished_file_path = os.path.join(self.base_run_dir, 'ENCHANTED.FINNISHED')
        with open(finished_file_path,'w') as file:
            file.write('ENCHANTED.FINNISHED')
